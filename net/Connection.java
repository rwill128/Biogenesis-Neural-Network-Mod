...
public class Connection {
	...
	public void deleteConnectionListener(ConnectionListener listener) {
	...
	public InCorridor getInCorridor() {
		return inCorridor;
	}
	
	public OutCorridor getOutCorridor() {
		return outCorridor;
	}
	 ...
	 */	
	public Connection(World world, InetAddress a, int p) {
		remotePort = p;
		remoteAddress = a;
	 ...
	 */
	public Connection(World world, InetAddress a, int p, int nCode) {
		remotePort = p;
		remoteAddress = a;
		state = STATE_NOT_INITIALIZED;
		netCode = nCode;
	...
	private void createCorridors() {
		inCorridor = new InCorridor(world);
		outCorridor = new OutCorridor(world, this);
	}
	/**
