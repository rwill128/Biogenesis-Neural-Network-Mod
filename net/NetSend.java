...
public class NetSend extends Thread {
	...
	public void run() {
		...
		try {
			...
			System.out.println("Connection closed with "+connection.getRemoteAddress()+ //$NON-NLS-1$
					":"+connection.getRemotePort()); //$NON-NLS-1$
	...
	private void handleConnect() throws ConnectException, IOException, UnknownHostException {
		...
		oos.writeInt(Utils.getLOCAL_PORT());
